...
public class MessageAdapter extends SelectableAdapter<Message, MessageAdapter.MessageViewHolder> {
    ...
    public static abstract class MessageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void setMessage(Context context, Message message, boolean selected) {
            mText = message;
            mContext = context;
        }
    ...
    public static class ViewHolder extends MessageViewHolder {
        ...
        public void setMessage(Context context, Message message, boolean selected) {
            super.setMessage(context, message, selected);
            setBodyText(message.getBody());
            if (selected) {
                setColor(tintColor(context.getResources().getColor(R.color.colorPrimary)));
            } else {
    ...
    public static class LeftViewHolder extends ViewHolder {
        ...
        public void setMessage(Context context, Message message, boolean selected) {
            super.setMessage(context, message, selected);
            if (selected) {
                setColor(tintColor(context.getResources().getColor(R.color.colorGrey)));
            } else {
    ...
    public void onBindViewHolder(MessageViewHolder holder, int position) {
        boolean selected = isSelected(getMessage(position));
        holder.setMessage(mContext, getMessage(position), selected);
    }
